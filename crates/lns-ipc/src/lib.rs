...
pub use protocol::{
    ArtifactInspection, BindMount, BindSpec, BuildContextFile, BuildSourceView, BuiltArchitecture,
    ...
    PackedFilesetSource, PortPublish, Protocol, PushableImage, PushableLayer, RegistryLoginSummary,
