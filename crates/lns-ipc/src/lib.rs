...
pub use protocol::{
    ...
    DisplacedEntry, ExecImageArgs, FilesetOrigin, ImageInfo, ImageView, LogLevel, MixinView,
    MountSpec, PortPublish, Protocol, Request, Response, RunConfig, RunDetails, RunImageArgs,
    RunStatsInfo, RunStatus, RunSummary, SandboxFileset, SandboxFilesetOwner, SandboxMount,
    SandboxMountKind, SandboxPort, SandboxView, SignalKind, SourceContribution, StatusInfo,
    VolumeInfo, VolumeMount, VolumePruneFailure, cmdline_unsafe_char, validate_bind_source,
