...
pub use protocol::{
    ArtifactInspection, BindMount, BindSpec, CredentialBackendKind, CredentialBindDecision,
    ExecImageArgs, ImageInfo, ImageView, LogLevel, MountSpec, PortPublish, Protocol, Request,
