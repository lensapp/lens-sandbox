...
# produces, so a stale fixture cannot pass silently. It does not yet run fmt or
# clippy over this out-of-workspace crate, so nothing lints it; adding them means
