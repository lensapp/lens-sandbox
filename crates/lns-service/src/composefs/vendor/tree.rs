...
use crate::composefs::vendor::fsverity::FsVerityHashValue;

pub use crate::composefs::vendor::generic_tree::{self, ImageError, Stat};
...
mod tests {
    ...
    use super::*;
    use crate::composefs::vendor::fsverity::Sha256HashValue;
    use crate::composefs::vendor::generic_tree::LeafId;
