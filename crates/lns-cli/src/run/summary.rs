...
/// The summary shows a path verbatim, names embedded files as inline, and names a host file as one so the operator sees which of their files a sandbox reads.
