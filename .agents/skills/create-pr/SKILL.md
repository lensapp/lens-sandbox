...
If there is a related Jira issue (mentioned by the user or visible in the branch name), add a link at the end of the PR body:

- **Fully solves the issue:** `Fixes https://mirantis.jira.com/browse/{issueId}`
- **Partial progress / related:** `Part of https://mirantis.jira.com/browse/{issueId}`
...
- **Don't add "Generated with Codex"** or any AI attribution to the PR body
