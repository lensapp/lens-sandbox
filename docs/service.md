...
names each question. Point to the mark to read what it asks. Open a row to see the
action its card showed, and everything that answers it. An open row answers the
entry, and clears it from the list, the way
