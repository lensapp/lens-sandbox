...
This installs the `lns` CLI and the `lns-service` background service. Lens Sandbox runs on **macOS on Apple Silicon** (M-series) today; Linux and Windows support are on the roadmap.
