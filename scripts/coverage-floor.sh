...
crates/lns-cli/src/build/run.rs                          build-command I/O tail: reads the manifest file and dispatches check/build/push; the report + push-target logic is host-tested at 100% in build/report.rs
