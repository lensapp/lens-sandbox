...
crates/lns-service/src/tools/real.rs                     composition root wiring cache::root + RealRecordStore/RealToolCache/MiseProvisioner under the machine-wide provision lock; the ensure_tools orchestration it drives is host-tested at 100% in tools/mod.rs. Pinned by the @microvm e2e tools feature.
