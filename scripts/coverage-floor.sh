...
crates/lns-supervisor/src/openshell.rs                   guest supervisor binary entry; Linux bootstrap runs only inside the microVM, and the non-Linux entry only reports unsupported platform and exits
